...
def query_claude(user_query: str, bedrock: boto3.client) -> Dict[str, Any]:
    ...
    system_prompt = """
Your task is to take information about a photo and extract data from it. You are to output each of your responses in exactly the following format:
{
  "summary": [
    { "label": "Subjects", "value": "3 people" },
    { "label": "Setting", "value": "Outdoors" },
    { "label": "Lighting", "value": "Natural daylight" },
    { "label": "Mood", "value": "Cheerful, friendly" },
    { "label": "Camera", "value": "35-50mm, f/4-5.6" },
    { "label": "Categories", "value": "7 analysis areas" }
  ],
  "accordion": {
